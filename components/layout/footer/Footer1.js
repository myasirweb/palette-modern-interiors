                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div className="footer-widget__column footer-widget__about">
                                ...
                                <div className="site-footer__social">
                                    <Link href="https://www.linkedin.com/in/yasirweb/"><i className="fab fa-linkedin"></i></Link>
                                    <Link href="https://github.com/myasirweb"><i className="fab fa-github"></i></Link>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="site-footer__bottom-inner">
                        <p className="site-footer__bottom-text">© 2025
                            Copyright <Link href="https://yasir-portfolio-nextjs.vercel.app/">Muhammad Yasir.</Link> | All rights reserved</p>
